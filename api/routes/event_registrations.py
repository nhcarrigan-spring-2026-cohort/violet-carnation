...
@router.get("/{organization_id}/{event_id}/{user_id}", response_model=EventRegistrationIn)
...
@router.post("", response_model=EventRegistrationIn, status_code=status.HTTP_201_CREATED)
...
@router.delete("/{organization_id}/{event_id}/{user_id}", response_model=EventRegistrationIn)
