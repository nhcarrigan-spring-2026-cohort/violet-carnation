...
This directory is a small mono-repo where there is a client and server side code for a full stack app. The client is a nextjs app written in typescript, and the server is a fastapi app written in python, backed with a sqlite database.
